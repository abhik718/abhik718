# Hi there 👋  
## I'm **Abhik Sarkar** — Data Engineering & Analytics @ Siemens Healthineers
![Profile Views](https://komarev.com/ghpvc/?username=abhik718&color=blue)
...
### Summary
**Data Engineer** with over **4 years of experience** designing governed data platforms, **data warehousing**, and scalable **ETL/ELT** pipelines. Strong background in **data modeling**, **Medallion (zone-based) architecture**, and automation of data flows with a focus on **data quality**, **metadata**, and **lineage**. Proficient in **SQL**, **Python**, and **Apache Spark**, with hands-on experience in **Azure Databricks**, **Azure SQL**, and **Snowflake**. Experienced in building reliable, analytics-ready datasets, implementing validation and governance controls, and partnering with business and IT stakeholders to deliver transparent, compliant, and future-ready data solutions.
...
<p align="left">
  <!-- Row 2: Big Data, Streaming & ETL (replaced Kinesis with S3) -->
